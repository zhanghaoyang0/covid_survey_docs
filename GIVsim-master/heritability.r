...
n_pop = 50
n_markers = 200
h2 = 0.1 # heritability of the trait
...
for(i_rep in 1:rep){
    ### Generate Data ###
    markers = matrix(rbinom(n_markers*n_pop,2,0.5),ncol=n_markers)# Drawing markers from a binomial distribution, all have MAF 0.5
